...
import OverviewTab from "@/components/telemetry/OverviewTab";
import ThrottleTab from "@/components/telemetry/ThrottleTab";
                  ...
                  <Tabs defaultValue="overview" className="w-full">
                    ...
                    <TabsContent value="overview" className="mt-6">
                      <OverviewTab
                        ...
                        getLapSpecificData={getLapSpecificData}
