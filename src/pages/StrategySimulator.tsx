                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-green-400 font-medium">
                              {(
                                simulation.optimization.time_consistency * 100
                              ).toFixed(1)}
                              %
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-blue-400 font-medium">
                              {(
                                simulation.optimization.position_stability * 100
                              ).toFixed(1)}
                              %
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-yellow-400 font-medium">
                              {(
                                simulation.optimization.podium_probability * 100
                              ).toFixed(1)}
                              %
                            </span>
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-green-400 font-medium">
                              {Math.floor(
                                simulation.optimization.best_case_time / 60,
                              )}
                              :
                              {(simulation.optimization.best_case_time % 60)
                                .toFixed(0)
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-blue-400 font-medium">
                              P
                              {Math.round(
                                simulation.optimization.median_position,
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`font-medium ${
                                simulation.risk.strategy_robustness > 0.8
                                  ? "text-green-400"
                                  : simulation.risk.strategy_robustness > 0.6
                                    ? "text-yellow-400"
                                    : "text-red-400"
                              }`}
                            >
                                  ...
                                  >
                                    <div>
                                      ...
                                      <div className="text-xs text-gray-400 mt-1">
                                        ...
                                        • Risk:{" "}
                                        {Math.round(strategy.risk_score * 100)}%
                                      </div>
                                    </div>
                                    <div className="text-right">
                                      <div className="text-white font-medium">
